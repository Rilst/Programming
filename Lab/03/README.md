...
а из координат пустых клеток удалаються координаты на которых создались шары. Потом вызывается функция проверки линий, которая ищет линии из 5 и более шаров одинакового цвета
